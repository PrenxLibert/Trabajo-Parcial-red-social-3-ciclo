...
public:
    ...
    void setupUi(QDialog *Interfas)
    {
        ...
        tbxPublic->setGeometry(QRect(90, 70, 451, 371));
        ...
        tbxMPublic->setEnabled(true);
        tbxMPublic->setGeometry(QRect(20, 80, 511, 301));
        tbxMPublic->setReadOnly(true);
        ...
        tbxFollowers->setEnabled(true);
        tbxFollowers->setGeometry(QRect(10, 50, 521, 391));
        tbxFollowers->setReadOnly(true);
    ...
    void retranslateUi(QDialog *Interfas)
    {
        ...
        btnComentar->setText(QCoreApplication::translate("Interfas", "Visualizar", nullptr));
